...
def argparsing():
  parser = argparse.ArgumentParser(description='FCLmser')
  ...
  parser.add_argument('--alpha', default=0.4, type=float, help='weight of skip/backward connection')
  parser.add_argument('--layers', default=[0,1,2,3], type=list, help='layers using feedback connections')
...
if __name__ == '__main__':
  ...
  # import dependencies
  CORE = importlib.import_module('pytorch_version')
